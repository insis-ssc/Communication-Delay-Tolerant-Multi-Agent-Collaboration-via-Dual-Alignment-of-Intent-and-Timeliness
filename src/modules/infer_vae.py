...
class InferVAE(nn.Module):
    """
    Variational autoencoder to embed trajectory into a continuous latent space. This VAE leverages a closed loop decoder
