...
if __name__ == '__main__':
    ...
    if parse_command(params, "env", config_dict['env']) == "foraging":
        map_name = "foraging"
    elif parse_command(params, "env", config_dict['env']) == "join1":
        map_name = "join1"
    elif parse_command(params, "env", config_dict['env']) == "gymma":
        print(config_dict)
    ...
    save_path =  parse_command(params, "local_results_path", config_dict['local_results_path'])
    results_path = os.path.join(dirname(dirname(abspath(__file__))), save_path)
