...
class Code_learner:
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        for t in range(batch.max_seq_length):
            agent_outs, returns_, intent, intent_embed = self.mac.forward(batch, t=t, t_env=t_env,
        ...
        infer_loss = infer_loss / calculate_num / batch_size
        ...
        for t in range(batch.max_seq_length):
            target_agent_outs, _, _,_ = self.target_mac.forward(batch, t=t, t_env=t_env)
